...
public class menu_pemilik extends javax.swing.JFrame {
    ...
    private Object[] header = {"ID OBAT", "Nama Obat", "Satuan", "Harga Beli", "Harga Jual", "Harga Box"};
    ...
    public void setTabel3(DefaultTableModel tabel) {
        this.laporanobat.setModel(tabel);
    }
        public void setTabel4(DefaultTableModel tabel) {
        this.tabelkas.setModel(tabel);
    }

    public int getSelectedRow() {
        return laporanobat.getSelectedRow();
    }

    public void tabelListener(MouseListener m) {
        laporanobat.addMouseListener(m);
    }

    public String getValueAt1(int baris, int kolom) {
        return (String) this.laporanobat.getValueAt(baris, kolom);
    }
    ...
    private void initComponents() {
        ...
        tb_datapegawai.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 100, 170, 40));
        ...
        tb_datapegawai.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 270, 170, 40));
        tb_datapegawai.add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 159, 350, 40));
        tb_datapegawai.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 325, 350, 40));
