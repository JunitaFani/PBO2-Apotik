...
public class ckaryawan_obat extends ckaryawan_menu {
    ...
    public ckaryawan_obat(model_karyawan modell, menu_karyawan menuu) throws SQLException {
        super(modell, menuu);
        this.menuu = menuu;
        this.modell = modell;
    ...
    private class getUbahObatUmum implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (menuu.getBarisObatUmum() < 0) {
                ...
                menuu.setHargaBeli().setText(Double.toString(hargabeli));
                menuu.setHargaSatuan().setText(Double.toString(hargasatuan));
                menuu.setHargaBox().setText(Double.toString(hargabox));
                menuu.showCard("tb_ObatUmum");
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                if (menuu.getNamaObat().equalsIgnoreCase("")
                    ...
                    double hargaBeli = Double.parseDouble(menuu.getHargaBeli());
                    double hargaSatuan = Double.parseDouble(menuu.getHargaSatuan());
                    double hargaBox = Double.parseDouble(menuu.getHargaBox());
