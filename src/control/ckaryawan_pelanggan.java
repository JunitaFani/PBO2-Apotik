 ...
 * @author JUNITA
 */
public final class ckaryawan_pelanggan extends ckaryawan_menu {
    ...
    public ckaryawan_pelanggan(model_karyawan modell, menu menuu) throws SQLException {
        super(modell, menuu);
        this.menuu = menuu;
        this.modell = modell;
        ...
        menuu.kembaliMenu1().addActionListener(new kembaliMenu());
        menuu.batal1().addActionListener(new batalPelanggan());
...
//        menuu.tanggalDaftar().setDate(null);
    ...
    private class batalPelanggan implements ActionListener {

        public batalPelanggan() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Logger.getLogger(ckaryawan_pelanggan.class.getName()).log(Level.SEVERE, null, ex);
...
//bagas
            try {
                if (menuu.getTanggalDaftar().equalsIgnoreCase("")
                        || menuu.getNamaPelanggan().equalsIgnoreCase("")
    ...
    private class HapuspelangganListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (menuu.getBaristabelpelanggan() < 0) {
                ...
                System.out.println("kolom" + menuu.getBaristabelpelanggan());
            } else {
                ...
                if (pilih == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        String kodepelanggan = menuu.getValueAt1(baris, 0);
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                if ( menuu.getTanggalDaftar().equalsIgnoreCase("")
                    ...
                    DefaultTableModel model = (DefaultTableModel) menuu.gettabelpelanggan().getModel();
                    int baris = menuu.getBaristabelpelanggan();
                    String namapelanggan = menuu.getNamaPelanggan();
                    String tglDaftar = menuu.getTanggalDaftar();
                    String tgllahir = menuu.getTanggallahir();
                    String alamat = menuu.getAlamat();
                    String notelp = menuu.getNotelp();
                    String kodepelanggan = menuu.getValueAt1(baris, 0);
                    modell.perbarui("public.datapelanggan SET tanggaldaftar='" + tglDaftar + "', namapelanggan='" + namapelanggan + "',id_jeniskelamin=" + jeniskelamin + ", "
                            + "tgllahir='" + tgllahir + "', alamat='" + alamat + "', notelp='" + notelp + "'WHERE kodepelanggan = " + kodepelanggan + ";");
                ...
                Logger.getLogger(ckaryawan_pelanggan.class
