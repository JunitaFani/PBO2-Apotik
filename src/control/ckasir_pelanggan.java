 ...
 * @author JUNITA
 */
public class ckasir_pelanggan extends ckasir_menu{
    ...
    public ckasir_pelanggan(model_kasir modell, menu menuu) throws SQLException {
        super(modell, menuu);
        this.menuu = menuu;
        this.modell = modell;
        menuu.showCard("dataPelanggan1");
        ...
        menuu.Searchpelanggan(new SearchPelanggan());
    ...
    private class SearchPelanggan implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Logger.getLogger(ckasir_pelanggan.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
